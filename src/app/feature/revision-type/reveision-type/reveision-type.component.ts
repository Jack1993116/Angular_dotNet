...
@Component({
  selector: 'app-reveision-type',
  templateUrl: './reveision-type.component.html',
  styleUrls: ['./reveision-type.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ReveisionTypeComponent extends BaseParent {
