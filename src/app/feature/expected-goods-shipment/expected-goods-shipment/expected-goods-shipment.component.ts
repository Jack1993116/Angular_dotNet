...
@Component({
  selector: 'app-expected-goods-shipment',
  templateUrl: './expected-goods-shipment.component.html',
  styleUrls: ['./expected-goods-shipment.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class ExpectedGoodsShipmentComponent extends BaseParent {
